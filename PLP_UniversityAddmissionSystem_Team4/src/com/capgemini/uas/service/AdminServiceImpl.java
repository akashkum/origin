...
public class AdminServiceImpl implements IAdminService {
	...
	@Override
	public List<ApplicationBean> getApplicantsByStatus(String status)
			throws UniversityException {
		return dao.getApplicantsByStatus(status);
	}

	@Override
	public void updateScheduledProg(String pId, ProgramScheduledBean bean)
			throws UniversityException {
		dao.updateScheduledProg(pId, bean);
		
	}

	@Override
	public ProgramScheduledBean getScheduledProgListForProgramId(String pId) throws UniversityException {
		return dao.getScheduledProgListForProgramId(pId);
	}
